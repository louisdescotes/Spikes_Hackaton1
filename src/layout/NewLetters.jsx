...
export default function NewLetters() {
  return (
    <div className="bg-white flex flex-col items-center justify-end gap-7 py-[55px] px-5 rounded-3xl my-20">
      <h4 className="text-[32px] text-center dela-regular text-[#0A071B]">
